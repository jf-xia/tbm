<script type="text/javascript">
    function help(){
        ...
        $("form div").eq(1).attr({"data-step":"3","data-intro":"选择是否关联产品，若选择“Yes”,那么在该任务表中会自动生成关联产品字段。"});
        $("form div").eq(2).attr({"data-step":"4","data-intro":"选择是否关联项目，若选择“Yes”,那么在该任务表中会自动生成关联项目字段目。"});
